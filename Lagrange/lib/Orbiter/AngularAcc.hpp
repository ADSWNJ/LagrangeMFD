...
#ifndef ANGULAR_ACC_HPP_INCLUDED
#define ANGULAR_ACC_HPP_INCLUDED
...
{
public:
	VECTOR3 GetMaxAngAcc( const VESSEL * v ) const;
	double GetMaxTorqueFromTHGroup( const VESSEL * v, THGROUP_TYPE thGroupType ) const;
